#ifndef TRACEQDCSCAN_HPP
#define TRACEQDCSCAN_HPP
...
class TraceQdcScanUnpacker : public Unpacker {
  public:
  	/// Default constructor.
	TraceQdcScanUnpacker() : Unpacker() {  }
	
	/// Destructor.
	~TraceQdcScanUnpacker(){  }
...
class TraceQdcScanScanner : public ScanInterface {
  public:
  	/// Default constructor.
	TraceQdcScanScanner();
